...
public class Proxy {
    ...
    public static BiFunction<Integer,Integer,Integer> rangeRandom = (t, u) -> (int)(Math.random()*(u-t))+ t;public static BiFunction<Integer,Integer,Integer> randgeRandom = (t, u) -> (int)(Math.random()* (u-t)) + t;   
